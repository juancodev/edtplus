    ...
    <>
      <footer className="relative">
        <div className="bg-slate-800 inset-0">
          ...
          <div className="mx-14 max-w-full px-6 max-md:mx-3 max-md:px-3">
            <div className="footer-block grid grid-cols-10 py-8 rounded-tt border-t border-slate-700 max-md:grid-cols-1">
              <div className="logo">
                <a href="#">
                  <img src={logo} width={70} height={70} alt="" />
                </a>
              </div>
              <div className="max-md:grid max-md:grid-cols-2 hidden">
              ...
              <div className="max-md:grid max-md:grid-cols-2 max-md:grid-rows-2 hidden">
                <div className="col-span-2 text-sm max-md:col-auto">
                  <h6 className="text-white font-bold mb-3">
                    Nuestros productos
                  </h6>
