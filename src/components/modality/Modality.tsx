                ...
                >
                  ...
                  <section className="py-6 max-md:py-3">
                    <div className="container p-4 mx-auto sm:p-10">
                      <div className="grid max-w-md grid-cols-1 gap-6 mx-auto auto-rows-fr max-md:auto-rows-auto lg:grid-cols-3 lg:max-w-full">
                        <div className="flex flex-col overflow-hidden rounded-md hover:-translate-y-6 hover:duration-500 hover:text-[#0072ce] hover:duration-300">
                          <div className="h-1/2 w-full px-2 py-8 space-y-4 bg-white max-md:h-1/3 max-md:py-4">
                            <img
                          ...
                          <div className="h-full flex flex-col items-center justify-center gap-12 px-2 py-8 dark:bg-slate-800 max-md:gap-6 max-md:py-0">
                            <h3 className="mb-3 text-2xl font-bold max-md:text-xl">
                        ...
                        <div className="flex flex-col overflow-hidden rounded-md hover:-translate-y-6 hover:duration-500 hover:text-[#0072ce] hover:duration-300">
                          <div className="h-full w-full px-2 py-8 space-y-4 bg-white max-md:h-1/3 max-md:py-4">
                            <img
                              className="h-full w-full object-contain"
                        ...
                        <div className="flex flex-col overflow-hidden  rounded-md hover:-translate-y-6 hover:duration-500 hover:text-[#0072ce] hover:duration-300">
                          <div className="h-full w-full px-2 py-8 space-y-4 dark:bg-white max-md:h-1/3 max-md:py-4">
                            <img
                              className="h-full w-full object-contain"
